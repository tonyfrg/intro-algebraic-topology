...
\begin{exemple}
Sur l'espace euclidien $\bb{R}^n$, tout couple de points possèdent un chemin linéaire. Pour $x,y\in\bb{R}^n$, ce chemin est donné par l'application $t\mapsto (1-t)x+ty$.
\end{exemple}
...
De plus, si $f$ vérifie $f(x)=f(x')\Rightarrow x\sim x'$ pour tout $(x,x')\in X^2$ éléments de $X$, alors $\overline{f}$ est injective.
\end{theorem}
