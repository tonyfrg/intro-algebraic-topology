...
C’est dans le même espoir que la topologie algébrique s'inscrit : l’objectif est de classifier les espaces topologiques homéomorphes. Il a cependant été démontré \cite{homeoImpossible} qu’il est impossible d’effectuer un tel résultat. Alors, la topologie algébrique recherche des outils permettant une classification de ces espaces, prenant en compte les invariants topologiques.
